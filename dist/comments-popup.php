...
<p><a href="<?php echo get_option('siteurl'); ?>/wp-commentsrss2.php?p=<?php echo $post->ID; ?>"><abbr title="Really Simple Syndication">RSS</abbr>-Kommentarfeed zu diesem Beitrag.</a></p>

<?php if ('open' == $post->ping_status) { ?>
<p>Die TrackBack-<abbr title="Universal Resource Locator">URL</abbr> dieses Beitrags lautet: <em><?php trackback_url() ?></em></p>
